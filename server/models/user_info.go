...
func (m *UserInfo) validateUser(formats strfmt.Registry) error {
...
func (m *UserInfo) contextValidateUser(ctx context.Context, formats strfmt.Registry) error {
